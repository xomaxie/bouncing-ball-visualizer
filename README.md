...
- `MUSIC_VISUALIZER_YOUTUBE_MAX_DURATION_SECONDS` (default `3600`)
- `MUSIC_VISUALIZER_YOUTUBE_MAX_FILESIZE` (default `250M`)
- `MUSIC_VISUALIZER_YOUTUBE_IMPORT_TIMEOUT_SECONDS` (default `900`)
